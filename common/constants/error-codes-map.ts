export const errorCodeMap = {
  ...
  InvalidQueryParameter: { value: "InvalidQueryParameter", description: "The request contains invalid parameter " },
  InvalidQueryParameterValue: { value: "InvalidQueryParameterValue", description: "The request contains invalid value of parameter " },
